...
public abstract class Process implements Comparable<Process> {
  ...
  public int getWaitingTime() {
      int newint = getTurnaroundTime() - cpuTime;
      return newint - blockedTime; 
  }

  /**
   *  Returns the turnaround time of the process.
   *  Time Difference between Created Time and Terminated Time  
   */
  ...
  /**
   * Defines the natural ordering of processes by their priority.
   */
